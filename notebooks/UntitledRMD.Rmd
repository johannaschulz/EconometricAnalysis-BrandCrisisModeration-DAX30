...
# Convert MonthYear to Date if it's not already
data$MonthYear <- as.Date(data$MonthYear)

# Create the time series plot with the specified lines
...
```
```{r}
# mean of VWAP for each combination of Crisis and StrongBrand = Table Mean VWAP values by Crisis Status and Brand Strength
